...
- [x] Data extraction — 15,000+ realistic messy records generated (Synthetic Data using python)
- [x] Transform + clean pipeline 
- [ ] EDA and Machine Learning Techniques to explore and dig deeper in the data
